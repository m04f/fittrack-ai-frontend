...
const Dashboard = () => {
  ...
  const [todayWorkout, setTodayWorkout] = useState<UserPlanWorkout | null>(
    null,
  );
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Set recent workouts
        setRecentWorkouts(
          (workoutsData.results?.slice(0, 5) || []) as Workout[],
        );
        ...
        <Card className="fitness-card border-2 fitness-border-light shadow-lg hover:fitness-border transition-all duration-200">
          ...
          <CardContent>
            ...
            <Progress
              ...
              className="mt-2 h-2 progress-gradient"
            />
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              {user?.fitness_level
                ...
                : "Set your fitness level in profile"}
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              {user?.fitness_goal
                ...
                : "Set your fitness goal in profile"}
            </p>
          </CardContent>
        </Card>
      </div>
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                <div className="text-sm mb-2">
                  No plan for today. Here are some suggestions:
                </div>
                {recentWorkouts.slice(0, 3).map((workout) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-muted-foreground">
                        {workout.exercises?.length || 0} exercises • By{" "}
                        {workout.creator}
                      </div>
                    </div>
                    <Button variant="ghost" size="icon" asChild>
